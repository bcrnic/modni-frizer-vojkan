    ...
    <section className="section-padding">
      <div className="container mx-auto">
        <ScrollReveal className="max-w-3xl mx-auto">
          <h2 className="heading-section mb-10 text-center">Česta pitanja</h2>

          <div className="space-y-8">
            <div className="p-6 bg-card border border-border">
              <h3 className="font-heading text-xl mb-2">Da li je potrebno zakazivanje?</h3>
              <p className="text-muted-foreground leading-relaxed">
                Zakazivanje nije obavezno. Uvek primamo i klijente bez zakazivanja. Za kraće čekanje preporučujemo
                zakazivanje termina unapred.
              </p>
            </div>
